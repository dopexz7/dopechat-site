...
const ChangelogData:FC = () => {
  return (
    <>
      ...
      <div className="m-3">
        -Official website! dopechat.ddns.net - Extension overview, a look at
        features, changelog, dashboard.
        <div className="">--Dashboard</div>
        <div className="">--Current dashboard features:</div>
        <div>
          ---Streamers now can create their own emote set (RatedEpicz, Ramee,
          Vader sets are already in)
        </div>
        <div className="">---Login with Twitch and upload your own emotes</div>
        ...
        <div className="">---View all current emotes in the extension</div>
        ...
        <div>
          ...
          handpicked by extension mods. Will be constantly updated with new
          emotes.
        </div>
        <div>---Channel emotes:</div>
        <div>
          ----If the streamer has an emote set made in the new website, mods
          will approve it and it will automatically be enabled on the channel
          ready to use.
        </div>
        <div>-Improved settings UI:</div>
        <div>
          --Font settings now show 50+ font options, with the ability to add
          your own fonts
        </div>
        <div>--Random username colors toggle (enabled by default)</div>
        <div>
          --Made it easier to add new highlighted keywords, with a &quot;Remove
          all&quot; button
        </div>
        <div>-Updated emote menu:</div>
        <div>--Reworked emote menu completely</div>
        <div>
          --You can either click on the emote menu button or ALT+E to bring up
          the emote menu (it&apos;s no longer draggable)
        </div>
        <div>--Emote menu search:</div>
        <div>---TAB to autocomplete the emote name</div>
        <div>
          ---TAB also inputs the first emote into the chatbox (if you have typed
          anything in it)
        </div>
        <div>--Left navigation:</div>
        <div>---Buttons for global/streamer emotes and extension settings</div>
        ...
        <div>
          ...
          starting with &quot;Pepe&quot;, &quot;PepeL&quot; or &quot;Pepeg&quot;
          narrows downthe search and so on.
        </div>
        <div>
          --Theatre mode no longer has a button, use the keyboard shortcut ALT+T
          (button clutter)
        </div>
        <div>-Moved &quot;Enable emote set&quot; to the Other settings tab</div>
        <div>
        ...
        <div>-Timestamps in chat toggle (in settings, hidden by default)</div>
      </div>
      ...
      <div className="m-3">
        ...
        <div className="">-moved reset to default settings to about page</div>
      ...
      <div className="m-3">
        ...
        <div className="">
          ...
          anymore, so it won&apos;t update live, but either after something has
          changed in the page like a new message typed in chat, or you refresh
          the page
        </div>
        <div className="">
          -random username coloring doesn&apos;t check every half a second
          anymore, it now detects if there&apos;s a new message in chat and
          updates instantly
        </div>
      ...
      <div className="m-3">
        <div className="">
          double click to open emote menu, so that it doesn&apos;t open while
          dragging
        </div>
      ...
      <div className="m-3">
        ...
        <div className="">-installed emote set visible in the popup menu</div>
        <div className="">
        ...
        <div className="">added tooltips for emotes in the emote menu</div>
        <div className="">minor improvements</div>
      </div>
      <div className="bg-darker-purple px-3 py-1 flex text-main-white w-max rounded-2xl">
        0.2.7
      ...
      <div className="m-3">
        ...
        <div className="">readability setting: separate chat messages</div>
      ...
      <div className="m-3">
        ...
        <div className="">fixed chat messages alignment with usernames</div>
