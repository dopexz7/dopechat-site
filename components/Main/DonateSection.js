      ...
      <div className="flex flex-col w-full lg:w-1/4">
        ...
        <Fade left>
          <div className="paypal-button group">
            ...
            <div className="absolute top-0 left-0 right-0 bottom-0 z-10 bg-accent-white pointer-events-none duration-300 border-2 group-hover:bg-darker-purple group-hover:border-darker-purple group-hover:text-white flex-row items-center justify-center flex  p-6 text-accent-purple font-normal rounded-3xl">
