...
export const LookAtFeatures = () => {
  return (
    <>
    <div id="alookat" className='lg:h-screen mx-6 lg:mx-36 flex flex-col font-bold'>
        <h1 className='text-xl lg:text-lg font-bold text-ma-pink uppercase'>A look at the extension's features</h1>
        <div className='opacity-50 mt-10 h-[calc(240 * 2)px] lg:h-3/4 flex flex-col lg:flex-row w-full space-y-3 lg:space-y-0 lg:space-x-6'>
          <div className='w-full h-60 lg:h-auto lg:w-1/4 relative flex items-center justify-center rounded-2xl'>
            ...
            <img className='z-10 w-full rounded-2xl h-full duration-300' src="https://i.imgur.com/PXH32YX.png"/>
          </div>
          <div className='w-full h-60 lg:h-auto relative flex items-center justify-center rounded-2xl'>
            ...
            <img className='z-10 w-full rounded-3xl h-full duration-300' src="https://i.imgur.com/GuqL0TJ.png"/>
          </div>
        </div>
      </div>
    </>
