...
const MainFooter = () => {
  ...
  return (
    <>
    <div id="footer" className='w-screen flex flex-col lg:flex-row lg:px-[60px] py-[60px] mt-24'>
        <div className='lg:pl-11 mx-0 w-full h-full my-auto'>
          ...
          <div className="w-1/2 flex flex-col space-y-2 mt-3">
              <div className="text-ma-pink text-xl font-bold">FEATURES</div>
        ...
        <div className='border-l-[1px] pb-3 border-opacity-5 border-white pl-11 w-screen max-w-2xl flex flex-col ml-auto font-bold'>
          <h1 className='text-2xl lg:text-lg font-bold text-ma-pink uppercase pb-7'>Links</h1>
