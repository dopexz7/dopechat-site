...
export default function MainAdmin() {
  return (
    ...
    //         <div className="">Your emotes</div>
    //         <div
    //           className="ml-3 border-2 text-main-purple hover:text-white cursor-pointer duration-300 hover:border-main-purple hover:bg-main-purple text-white rounded-3xl px-3"
