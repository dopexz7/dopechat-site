...
const DashboardNav:FC = () => {
  ...
  return (
    <div className={`duration-300 z-50 w-screen bg-darker-purple`}>
      <div
        className={`max-w-6xl w-screen mr-auto ml-auto flex flex-row justify-center items-center p-6 duration-300 space-x-8 text-main-white text-sm font-semibold`}
      >
        <Link href="/" passHref>
